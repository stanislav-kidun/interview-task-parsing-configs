...
Instead of writing everything in one file, I decided to create some project structure and split the code into several files. Here is some explanation of this split:
